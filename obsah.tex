...
To guarantee that this will not happen we create the new FA $F=(T_1 \cdots T_n, \iport)$
in the following way.
For each $1 \leq i \leq n: T_i$
and for each $(r,s)$ in $T_i$
there is created FA $F=(T_1 \cdots T_n, \iport)$
...
The backward run and predicate abstraction were evaluated on SV-COMP benchmark and
Forester test suite.
