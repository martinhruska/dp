...
However, completing algorithm for redution of tree automata in VATA would be one of the goals
in the future work and without it we cannot fully confirm this assumption.
...
\begin{table}[buh]
	...
	\begin{tabular}{|l | c | c |}
		...
		\hline
		\hline
		SLL with CSLL            & $2.07$ & $0.85$ \\
		\hline
		DLL with CDLL            & $4.03$ & $1.43$ \\
		\hline
		Skiplist, the 3rd level  & $46.00$ & $15.00$ \\
		\hline
		Skiplist, the 2nd level  & $0.60$ & $0.40$ \\
		\hline
		Linux driver snippet     & $1.92$ & $1.07$ \\ 
		\hline
	\end{tabular}
	\caption{Comparison of Forester with and without VATA on the hard cases.
