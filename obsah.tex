...
We also checked whether the real errors are
really marked as real.
Note that before the implmentation of backward run
Forester was not able to confirm that a found error is real.

The implementation of backward run confirms the $6$ real errors in the programs
...
The test cases with the~spurious counterexamples are further resolved by implementing predicate
abstraction.
