...
\begin{itemize}
	...
	\item {\tt FI\_push\_greg($r_g$)}
		...
		last global register added $\sfwd$ is removed the new state.
...
the same registers as the symbolic state $\sbwd$ and
substituting of the original destination register $r_d$ of $S'$
