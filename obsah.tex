...
We described backward run generaly in the beginning of this chapter.
...
The extension by backward run is quite straightward.
...
Indeed, it is sufficent to compute intersect FA only for
...
that they could reversed withou needing to make intersection.
...
\begin{itemize}
	...
	\item {\tt FI\_node\_free}
		...
		It is also neccesery to relabel the selectors of FA in $\sbwd$
	...
	\item {\tt FI\_acc\_set,FI\_acc\_all}
		...
		the semantic of these instrctions is empty.
