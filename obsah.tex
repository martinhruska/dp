...
Further we use $\ftrace = \ftraceseq$ to denote a forward trace of the symbolic states explored during
...
The symbolic execution is done by iterating over the $\ftrace$ and for each
...
\begin{itemize}
	...
	\item {\tt FI\_abs(), FI\_fix()}
		...
		Then a new FA create by intersection of FA of $\sbwd$ and FA of $\sfwd$ is assigned
