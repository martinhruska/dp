...
It was also implemented in tool Forester.

Backward run and predicate abstraction were evaluated on SV-COMP benchmark and
Forester test suite.
It enables analysing of some new programs.
...
On the other side, a lot of cases were not analysed
because Forester does not support used C language constructions
or analysing of a program lead to an internal verfier error.
Predicate abstraction is not also fully complete.
It needs to further improved to get better performance
and to be able to continue also when a garbage is
created (and a program is, for example, verified for absence of invalid
dereferences).
Then there are also conceptual improvements of the theory.
The backward run and predicate analysis should be generalized
to the hierarchical forest automata.
A generalazition of predicates to make possible to verifity
data structures like singly-link lists is another challange.
