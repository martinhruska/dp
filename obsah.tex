...
to perform the predicate abstraction over forest automata component wise.
...
Now a comparison of the performance of the particular programs analysis 
...
The backward run, including FA interseciton, and predicate analysis should be generalized
