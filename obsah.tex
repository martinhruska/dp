...
We say that $F$ respects \emph{cannonicity} if $\forall f \in L_f(F): \emph{f is cannonical}$.
...
so it is possible to achieve cannonical forest as it was described in Section \ref{subsec:mcforest}.
