...
The high level overview of the analysis performed by
...
or several instructions associated with the abstract transformers.
The symbolic execution is then run over this microcode.
The abstract domain of FA 
(which are also the core part of a symbolic state)
is gradually transformed by execution of the microcode instruction.
