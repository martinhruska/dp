...
\projectinfo{
  ...
  abstract.cs={
	  ...
	  Prvním přínosem této práce je nahrazení této implementace knihovnou VATA, která obsahuje algoritmy
	  ...
	  Výsledek této analýzy určuje, zdali nalezené chyba je reálná nebo nepravá, což lze dále použít pro zjemnění
  ...
  abstract.en={
	  ...
	  Furthermore, we design and implement predicate abstraction with the information from backward run.
