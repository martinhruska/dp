...
\projectinfo{
  ...
  abstract.cs={
	  ...
	  Koncept lesních automatů je založen na stromových automatech a verifikační procedura na nich založená byla implementován v nástroji Forester.
  ...
  abstract.en={
	  ...
	  However there is the VATA library which implements the efficient algorithms for tree automata manipulation,
