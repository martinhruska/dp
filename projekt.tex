...
\projectinfo{
  ...
  abstract.cs={
	  ...
	  Koncept lesních automatů je založen na stromových automatech a verifikační procedura na lesních automatech založená byla implementována v nástroji Forester.
	  ...
	  abstrakcí použitou ve verifikační proceduře, což je informace použitelná pro zjemnění predikátové abstrakce.
  ...
  acknowledgment={Rád bych poděkoval vedoucímu této práce, Mgr. Lukáši Holíkovi, Ph.D., za to, že se mnou byl ochoten sdílet svoje zkušenosti jednoho z nejprestižnějších vědců v naší galaxii.
  ...
  se kterou pronikal přes trnité hradby zdrojových kódů, mi šel příkladem.
  Za konzultace a odborné rady také děkuji Prof. Ing. Tomáši Vojnarovi, Ph.D., a děkuji také za to, že mi poskytnul možnost vypracovat tuto práci v prostředí skupiny VeriFIT a nechal mě pracovat
  po svém boku, což mi přineslo, mimo jiné, obohacení slovní zásoby o mnoho výrazů a slovních spojení, které se mi zcela jistě budou v dalším studiu, ale také odoborné kariéře, hodit.} % nepovinne
}
