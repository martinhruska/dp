...
\projectinfo{
  ...
  abstract.en={
      ...
      a found error is a~spurious or a real one.
	  The results can be also used for refinement of predicate abstraction.
	  Predicate abstraction using information from backward run is also designed and implemented as
	  part of this thesis.
